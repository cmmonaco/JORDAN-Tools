---
title: "Normalization Report Template"
date: "Dec. 23, 2018"
authhor: "C.M. Monaco"
output:
  html_notebook:
...
This script is meant to be run on raw count data. The script should be edited where indicated by an `## EDIT ##`.
...
write.csv(file = "norm_counts.csv", final_norm_counts) 
```

Normalized counts written to the file `norm_counts.csv`.