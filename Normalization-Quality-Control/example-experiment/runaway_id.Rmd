---
title: "Run-Away Barcode Identification for Example Experiment"
date: "Jan. 27, 2018"
authhor: "C.M. Monaco"
output:
  html_notebook:
...
Based on Cluster Analysis and PCA, Barcodes `TGATATTG` and `ACGTCGAA` represent possible run-aways.